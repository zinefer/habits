<template>
  <div class="terms ml-auto mr-auto">
    ...
    <p>
      ...
      <a href="https://habits.watch">https://habits.watch</a>, you are agreeing
    ...
    <ol type="a">
      <li>
        ...
        (information or software) on Habits' website for personal,
      ...
      <li>
        ...
        restrictions and may be terminated by Habits at any time. Upon
    ...
    <ol type="a">
      <li>
        The materials on Habits' website are provided on an 'as is' basis.
        Habits makes no warranties, expressed or implied, and hereby disclaims
      ...
      <li>
        Further, Habits does not warrant or make any representations concerning
    ...
    <h3>4. Limitations</h3>
    <p>
      In no event shall Habits or its suppliers be liable for any damages
      ...
      materials on Habits' website, even if Habits or a Habits authorized
    ...
    <p>
      The materials appearing on Habits' website could include technical,
      typographical, or photographic errors. Habits does not warrant that any of
      the materials on its website are accurate, complete or current. Habits may
      make changes to the materials contained on its website at any time without
      notice. However Habits does not make any commitment to update the
      materials.
    </p>
    <h3>6. Links</h3>
    <p>
      Habits has not reviewed all of the sites linked to its website and is not
      responsible for the contents of any such linked site. The inclusion of any
      link does not imply endorsement by Habits of the site. Use of any such
      linked website is at the user's own risk.
    </p>
    <h3>7. Modifications</h3>
    <p>
      Habits may revise these terms of service for its website at any time
    ...
    <p>
      ...
      with the laws of Colorado and you irrevocably submit to the exclusive
